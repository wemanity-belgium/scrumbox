...
import com.wemanity.scrumbox.android.db.dao.RoleDao;
 ...
 * DAO for table ROLE.
*/
public class RoleGreenDao extends AbstractDao<Role, Long> implements RoleDao {
    ...
    */
    ...
    public RoleGreenDao(DaoConfig config) {
        super(config);
    }
    
    public RoleGreenDao(DaoConfig config, DaoSession daoSession) {
