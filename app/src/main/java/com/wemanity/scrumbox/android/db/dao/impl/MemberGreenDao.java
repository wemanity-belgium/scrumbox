...
import com.wemanity.scrumbox.android.db.dao.MemberDao;
...
*/
public class MemberGreenDao extends AbstractDao<Member, Long> implements MemberDao {
    ...
    */
    ...
    public MemberGreenDao(DaoConfig config) {
        super(config);
    }
    
    public MemberGreenDao(DaoConfig config, DaoSession daoSession) {
